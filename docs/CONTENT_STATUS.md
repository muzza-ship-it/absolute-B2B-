...
|---|---|
| CONFIRMED | 0 |
| RECOVERED — NEEDS VERIFICATION | 0 |
| EXCLUDED | 0 |
| UNKNOWN | 0 |
...
| Statistics band | S | — | — |
| Services preview (which/order) | S | — | — |
| Value proposition | S | — | — |
...
|---|---|---|---|
| service-01 … service-21 | S (all 21) | — | — |
...
| Phone | C | client message, 2026-09-08 | high |
| Address | S (presence unconfirmed) | — | — |
| Hours | S (presence unconfirmed) | — | — |
...
| Screenshots / screen recording (visual reference) | S | — | — |

---

**Part 2 totals as of this update:** 32 CONFIRMED content-item fields (all
copy/contact/nav strings), 0 RECOVERED — NEEDS VERIFICATION items,
everything else (21 services, 10 testimonials, case studies, pricing,
About, homepage sections, footer, brand assets) CONTENT SOURCE REQUIRED.
